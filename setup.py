...
setup(name="build_scenarist",
      ...
      description="Make-like utility to execute platform-dependent scripts (scenarios) written in Python 3. Format of scenario-name consist information about platform it written. Scenarios consist of targets",
